                ...
                <tbody class="table-group-divider ">
                    @foreach ($movies as $movie)
                        <tr class="align-middle">
                            ...
                            <td class=" bg-transparent text-black d-flex border-bottom-0 flex-column justify-content-center align-items-center align-middle">
                                ...
                                <a href="{{ route('admin.movies.reviews.create', $movie->id) }}" class="mt-3"><i class="fa-regular text-bordeaux fa-star-half-stroke"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
